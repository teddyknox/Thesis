...
\begin{figure}[tp]
\centering
\includegraphics[width=\textwidth]{visualizations/smart-pretty.png}
\caption{A random sample of generative art rated positively by the classifier.}
\label{fig:positive-geneartive-art}
\end{figure}
...
\lstset{language=bash, caption=Experiment Script}
\lstinputlisting{../../src/experiments/googlenet/kfolds_googlenet.sh}
\clearpage
\lstset{language=python, caption=Image Generator}
\lstinputlisting{../../src/generators.py}
\clearpage
\lstset{language=python, caption=K-Folds Data Splitter}
\lstinputlisting{../../src/scripts/write_manifests.py}
\clearpage
\lstset{language=python, caption=Training Interface}
\lstinputlisting{../../src/web/views.py}
\clearpage
\lstset{language=python, caption=Training Interface Backend}
\lstinputlisting{../../src/web/views.py}
\clearpage
\lstset{language=python, caption=Python-Caffe Interface}
\lstinputlisting{../../src/web/views.py}
